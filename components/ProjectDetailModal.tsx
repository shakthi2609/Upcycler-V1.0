...
import { BackArrowIcon, YouTubeIcon, TrashIcon, ImageIcon } from './icons';
    ...
    <div className="bg-white rounded-lg shadow-xl max-w-5xl w-full mx-auto p-6 sm:p-8 lg:p-12">
        <div className="flex justify-between items-center mb-8">
            ...
            <button
                ...
                className="inline-flex items-center text-red-600 hover:text-red-800 transition-colors font-semibold text-sm"
            >
      ...
      <div className="border-t pt-8 mt-8">
       ...
       <div className="border-t pt-8 mt-8">
          <h3 className="text-3xl font-semibold text-gray-800 mb-6">My Project Journal</h3>
          <div className="bg-gray-50 p-6 rounded-lg">
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <label htmlFor="photo-upload" className="cursor-pointer inline-flex items-center px-4 py-2 bg-white text-green-700 border border-green-300 rounded-md hover:bg-green-50">
                ...
                project.journal.slice().reverse().map(entry => (
                    <div key={entry.id} className="flex items-start space-x-4 p-4 border rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-400 mt-2">{new Date(entry.date).toLocaleString()}</p>
                        </div>
                    </div>
                ))
            ) : (
