  ...
  if (projects.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="mt-2 text-sm font-medium text-gray-900">No saved projects</h3>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {projects.map((project) => (
        <div key={project.id} className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col transform hover:-translate-y-1 transition-transform duration-300 ease-in-out">
          {project.imageUrl ? (
